...
Host: example.com
Content-Length: 0
Via: 1.1 sahp6005.sandia.gov (squid/3.1.23)
...
my $flair   = <<'EOF';
<div><br />PUT /api/people/1 HTTP/1.1<br />User-Agent: Mozilla/5.0 (Windows NT; Windows NT 6.2; en-US) WindowsPowerShell/4.0<br />Host: <span class="entity domain" data-entity-type="domain" data-entity-value="example.com">example.com</span><br />Content-Length: 0<br />Via: 1.1 <span class="entity domain" data-entity-type="domain" data-entity-value="sahp6005.sandia.gov">sahp6005.sandia.gov</span> (squid/3.1.23)<br />X-Forwarded-For: <span class="entity ipaddr" data-entity-type="ipaddr" data-entity-value="134.253.10.234">134.253.10.234</span><br />Cache-Control: max-age=259200<br />Connection: Keep-Alive<br />HTTP/1.1 405 Method Not Allowed<br />Cache-Control: max-age=604800<br />Date: Wed, 28 Sep 2016 16:53:26 GMT<br />Expires: Wed, 05 Oct 2016 16:53:26 GMT<br />Server: EOS (lax004/28A3)<br />Content-Length: 0<br /></div>
EOF
