...
$source = q|<html><img src="http://www.sandia.gov/_assets/images/features/fiber-optic-network.jpg"></img>192.168.0.1</html>|;
$entity_href    = $extractor->process_html($source);
$expected_href  = {
    'flair' => '<html><head></head><body><p><img src="http://www.sandia.gov/_assets/images/features/fiber-optic-network.jpg" /><span class="entity ipaddr" data-entity-type="ipaddr" data-entity-value="192.168.0.1">192.168.0.1</span></body></html>',
    'text' => '192.168.0.1',
    'entities' => [
        { 'value' => '192.168.0.1', 'type' => 'ipaddr' }
    ]
...
$entity_href    = $extractor->process_html($source);
$expected_href  = {
'flair' => '<html><head><meta content="text/html; charset=utf-8" http-equiv="Content-Type" /></head><body><p>&nbsp;<p><strong><font color="red">Sem12 Database&nbsp; --All SRN SEP 12 Clients--</font></strong><p><table border="1"><thead><tr style="font-weight:bold"><th>APP_Name</th><th>APPLICATION_PATH</th><th>APPZ_Description</th><th>CHECKSUM</th><th>COMPUTER_NAME</th><th>Computer_Time_Stamp</th><th>CURRENT_LOGIN_DOMAIN</th><th>CURRENT_LOGIN_USER</th><th>FILE_SIZE</th><th>LAST_ACCESS_TIME</th><th>LAST_MODIFY_TIME</th><th>OPERATION_SYSTEM</th><th>SEM_Computer_Time_Stamp</th><th>SERVICE_PACK</th><th>TIME_STAMP</th><th>TIME_STAMP_SEMAPPLICATION</th><th>VERSION</th></tr></thead><tbody><tr><td><span class="entity domain" data-entity-type="domain" data-entity-value="microsoft.datawarehouse.resources.dll">microsoft.<span class="entity domain" data-entity-type="domain" data-entity-value="datawarehouse.resources.dll">datawarehouse.<span class="entity domain" data-entity-type="domain" data-entity-value="resources.dll">resources.dll</span></span></span></td><td>c:\\program files (x86)\\microsoft office\\office15\\addins\\powerpivot excel add-in\\tr\\</td><td>Microsoft.DataWarehouse</td><td><span class="entity md5" data-entity-type="md5" data-entity-value="48BDCA4A5C014B1F8605E23D485D8DC0">48BDCA4A5C014B1F8605E23D485D8DC0</span></td><td>DAASE320W7</td><td>1441924911470</td><td><span class="entity domain" data-entity-type="domain" data-entity-value="SRN.SANDIA.GOV">SRN.<span class="entity domain" data-entity-type="domain" data-entity-value="SANDIA.GOV">SANDIA.GOV</span></span></td><td>jnirsch</td><td>319136</td><td>0</td><td>1414584654000</td><td>Windows 7 Enterprise Edition</td><td>1441964684085</td><td>Service Pack 1</td><td>1441924911470</td><td>12/9/1985 10:41:51 PM</td><td>11.0.2830.24 ((BI_O15_OfficeBox-CU).141015-1558 )</td></tr><tr><td><span class="entity file" data-entity-type="file" data-entity-value="jeffretires.exe">jeffretires.exe</span></td><td>c:\\users\\dmkeiss\\appdata\\local\\temp\\<span class="entity file" data-entity-type="file" data-entity-value="temp2_jeffretires.zip">temp2_jeffretires.zip</span>\\</td><td></td><td><span class="entity md5" data-entity-type="md5" data-entity-value="0A0FFD00CD32B2F540114245CFED488E">0A0FFD00CD32B2F540114245CFED488E</span></td><td><span class="entity snumber" data-entity-type="snumber" data-entity-value="S964892">S964892</span></td><td>1441921551573</td><td><span class="entity domain" data-entity-type="domain" data-entity-value="SRN.SANDIA.GOV">SRN.<span class="entity domain" data-entity-type="domain" data-entity-value="SANDIA.GOV">SANDIA.GOV</span></span></td><td>dmkeiss</td><td>28672</td><td>130863945340120000</td><td>1441920578900</td><td>Windows 7 Enterprise Edition</td><td>1441963983746</td><td>Service Pack 1</td><td>1441921551573</td><td>12/9/1985 9:45:51 PM</td><td></td></tr></tbody></table><p><font color="lightgreen"></font>&nbsp;<p><font color="lightgreen">Sem12 Dev Database</font><p><table border="1"><thead><tr style="font-weight:bold"><th>APP_Name</th><th>APPLICATION_PATH</th><th>APPZ_Description</th><th>CHECKSUM</th><th>COMPUTER_NAME</th><th>Computer_Time_Stamp</th><th>CURRENT_LOGIN_DOMAIN</th><th>CURRENT_LOGIN_USER</th><th>FILE_SIZE</th><th>LAST_ACCESS_TIME</th><th>LAST_MODIFY_TIME</th><th>OPERATION_SYSTEM</th><th>SEM_Computer_Time_Stamp</th><th>SERVICE_PACK</th><th>TIME_STAMP</th><th>TIME_STAMP_SEMAPPLICATION</th><th>VERSION</th></tr></thead><tbody></tbody></table><p>&nbsp;<p>&nbsp;</body></html>',
          'entities' => [
                          {
                            'type' => 'domain',
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8"> </head> <body style="font-size: 14px; font-family: helvetica, arial, sans-serif; padding: 20px 0; margin: 0; color: #333;"> <div style="margin-top: 10px; padding-top: 20px; border-top: 1px solid #ccc;"></div> <a href="https://ms27snllx.sandia.gov:8000/app/search/@go?sid=scheduler__aaquint__search__RMD52d4de19f8b7990d9_at_1441976400_91131" style=" text-decoration: none; margin: 0 20px; color: #5379AF;">View results in Splunk</a> <div style="margin:0"> <div style="overflow: auto; width: 100%;"> <table cellpadding="0" cellspacing="0" border="0" class="results" style="margin: 20px;"> <tbody> <tr> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">_time</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">quarantined</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">HREF</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">MAILSUBJECT</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">MAIL_FROM</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">X_IronPort_RCPT_FROM</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">MAIL_TO</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">X_IronPort_RCPT_ALL</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">MESSAGE_ID</th> <th style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">docid</th> </tr> <tr valign="top"> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">Fri Sep 11 06:57:39 2015</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">False</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">http://members.trustedcomputinggroup.org/apps/org/workgroup/tpmwg/download.php/26487/latest/TPM2_SendObject_TCG_150901.zip http://members.trustedcomputinggroup.org/apps/org/workgroup/tpmwg/document.php?document_id=26487</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">RE: [tpmwg] Groups - TPM2_SendObject-Slides uploaded</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">david.challener@jhuapl.edu</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">tpmwg-return-14496-tqthai=sandia.gov@trustedcomputinggroup.org</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">tpmwg@trustedcomputinggroup.org andreas.fuchs@sit.fraunhofer.de tqthai@sandia.gov monty.wiseman@intel.com</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">tqthai@sandia.gov</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">1a9fecc1a3724327b294d91c461d20b0@aplex05.dom1.jhuapl.edu</td> <td style="text-align: left; padding: 4px 8px; border-bottom: 1px dotted #ccc;">71871d57f1d623fc21b9f3f36c9c245d</td> </tr> </tbody> </table> </div> </div> <div style="margin-top: 10px; border-top: 1px solid #ccc;"></div> <p style="margin: 20px; font-size: 11px; color: #999;">If you believe you've received this email in error, please see your Splunk administrator.<br><br>splunk &gt; the engine for machine data</p> </body> </html>};
