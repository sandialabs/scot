...
my $string = 'ip4:65.38.172.36 ip4:65.38.172.37 ip4:192.184.125.220 ip4:192.184.125.221 ip4:74.115.13.152 ip4:74.115.13.67 ip4:64.79.155.0/24 ip4:192.254.118.63/32';
my $re      = qr{
(?:
# Mixed
(?:
...
# negative look behind to stop ip4:a.b.c.d from matching
  (?<!ip4:)
)
