...
my $string  = qq|[1:90020059:2] "(JIM) SCOT-5696 Traffic from/to suspicious IP" [Impact: Unknown Target] From "MrKrabs ESnet IDS Engine/MrKrabs" at Sat May 16 17:46:32 2015 UTC [Classification: Critical - Send alert to scot-alerts.sandia.gov] [Priority: 1] {icmp} 64.237.51.163->132.175.62.167
|;
...
my $msg = {
    ...
    message_id  => '97912b1606804ab88d83e7a54521ad61@ES08AMSNLNT.srn.sandia.gov',
    body_plain  => $string,
    body        => $string,
    data        => [],
