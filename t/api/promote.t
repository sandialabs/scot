...
my $event1  = $t->tx->res->json->{pid};

$t->get_ok("/scot/api/v2/event/$event1" => {},
    "Get Event $event1")
    ->status_is(200)
    ->json_is('/promotions/from/0/type' => 'alert')
    ->json_is('/promotions/from/0/id'   => $alert_1_id);

$t->get_ok("/scot/api/v2/alert/$alert_1_id" => {},
    "Get Alert $alert_1_id")
    ->status_is(200)
    ->json_is('/promotions/to/0/type'   => 'event')
    ->json_is('/promotions/to/0/id'     => $event1);
...
$t->get_ok("/scot/api/v2/alert/$alert_2_id" => {},
    "Get Alert $alert_2_id")
    ->status_is(200)
    ->json_is('/promotions/to/0/type'   => 'event')
    ->json_is('/promotions/to/0/id'     => $event1);
...
$t->get_ok("/scot/api/v2/event/$event1" => {},
    "Get Event $event1")
    ->status_is(200)
    ->json_is('/promotions/from/1/type' => 'alert')
    ->json_is('/promotions/from/1/id'   => $alert_2_id);
...
my $incident1   = $t->tx->res->json->{pid};

$t->get_ok("/scot/api/v2/incident/$incident1" => {},
    "Get Incident $incident1")
    ->status_is(200)
    ->json_is('/promotions/from/0/type' => 'event')
    ->json_is('/promotions/from/0/id'   => $event1);

$t->get_ok("/scot/api/v2/event/$event1" => {},
    "Get Event $event1")
    ->status_is(200)
    ->json_is('/promotions/to/0/type' => 'incident')
    ->json_is('/promotions/to/0/id'   => $incident1);
...
$t->get_ok("/scot/api/v2/incident/$incident1" => {},
    ...
    ->json_is('/promotions/from/0/type' => 'event')
    ->json_is('/promotions/from/0/id'   => $event1)
    ->json_is('/promotions/from/1/type' => 'event')
    ->json_is('/promotions/from/1/id'   => $event2);

# NEED TO IMPLEMENT a "unpromote" or way to remove promoted links
...
$t->get_ok("/scot/api/v2/event/$event2" => {},
            "Checking event $event2")
    ->status_is(200)
    ->json_is('/status'     => 'open')
    ->json_is('/promotions/to'  => []);
    
$t->get_ok("/scot/api/v2/incident/$incident1" => {},
            "Checking incident $incident2")
    ->status_is(200)
    ->json_is('/promotions/from/0/id'   => $event1);
