...
(function ($, undefined) {
	...
	var tagsLoaded = 0;
        return function (qin) {
	    var query = qin;
	    if((tagsLoaded == 0) && (data.length > 0) && (data[0] == 'lazyLoadTags')) {
		   tagsLoaded = 1;
	    $.ajax({
		type: 'GET',
		url:  '/scot/tags'
		   ...
		   formated_data = Array();
                   $(response.data).each(function () {
                      formated_data.push({id: this, text: this});
                   });
		   filtered.results = formated_data;
                   query.callback(filtered);
	       });
	    } else {
          	  var t = query.term, filtered = {results: []};
                   $(isFunc ? data() : formated_data).each(function () {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                "class": "editable select2-container select2-container-multi"
            }).html([
...
//              choice.find('div').bind("click", monkey
            }
        ...
        clickedLink: function(input) {
           this.opts.element.data('onc')(input);
        },
        link: function (link) {
	  this.opts.element.data('onc', link);      
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable", "positionDropdown", "data", "link"];
    ...
    $.fn.select2.defaults = {
        ...
        formatSearching: function () { return "Loading Tags..."; },
