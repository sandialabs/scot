...
module.exports = React.createClass({
	...
	/*
        ...
        if (props.virtualRendering) {
            ...
            //h     state.renderStartIndex = renderStartIndex
            // }
	...
	var newarray = []
	if(check){
	   for(var i = 0; i<this.state.newcolumns.length; i++){
		newarray[i] = {name:this.state.newcolumns[i], width: 200, style:{color:'black'}, defaultHidden:false, defaultVisible: true, filterable:false, flexible:true,hidden:false,index:i,minWidth:200, resizable:true,sizeStyle:{flex:1,minWidth: 200},title:this.state.newcolumns[i],visible:true}
	    //    props.columns[i] = newarray[i]     	   
	    }
	   check = false
	   props.columns = newarray;
	}
