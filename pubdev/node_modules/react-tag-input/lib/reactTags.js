...
var ReactTags = React.createClass({
    ...
    render: function() {
        ...
        var defaultClass1='ReactTags__tagInput';
        var defaultClass2='ReactTags__tags';
        var defaultClass3='ReactTags__selected';
        console.log('before custom css')
        if (this.props.customCSS == 1) {
            defaultClass1='ReactTags__tagInput_custom';
            defaultClass2='ReactTags__tags_custom';
            defaultClass3='ReactTags__selected_custom';
        ...
        return (
            <div className={defaultClass2}>
                <div className={defaultClass3}>
                    {tagItems}
