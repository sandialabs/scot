...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        ]})), React.createElement(ActionBarRow, null, React.createElement(GroupedSelectedFilters, null), React.createElement(ResetFilters, null))), React.createElement(ViewSwitcherHits, {hitsPerPage: 12, highlightFields: ["title", "plot"], sourceFilter: ["plot", "title", "poster", "imdbId", "imdbRating", "year"], hitComponents: [
