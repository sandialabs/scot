...
describe("Hits component", function () {
    describe('renders correctly', function () {
        ...
        it("does render", function () {
            ...
            expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", {"data-qa": "hits", className: "sk-hits"}, React.createElement("div", {"data-qa": "hit", className: "sk-hits-hit sk-hits__item"}, "1"), React.createElement("div", {"data-qa": "hit", className: "sk-hits-hit sk-hits__item"}, "2"))));
        });
