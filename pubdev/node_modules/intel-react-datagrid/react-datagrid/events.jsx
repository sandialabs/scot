...
[
    ...
    { name: 'created', width:150, style: {color:'black'}},
    { name: 'updated', width:150, style: {color:'black'}},
    { name: 'subject', width:200, style: {color:'black'}},
    { name: 'sources', width:90, style: {color:'black'}},
    { name: 'tags', width:90, style: {color:'black'}},
    { name: 'owner',width:90, style: {color:'black'}},
    { name: 'entries', width:90, style: {color:'black'}},
    { name: 'views', width:90, style: {color:'black'}}
]
