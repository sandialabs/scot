...
var columns = 
[
    { name: 'id',width:90, style: {color: 'black'}},
    { name: 'doe', width:90, style: {color: 'black'}},
    { name: 'status', width:90},
    { name: 'owner', width:90, style: {color: 'black'}},
    { name: 'subject', width: 200, style: {color: 'black'}},    
    { name: 'occurred', width:100, style: {color: 'black'}},
    { name: 'discovered', width:100, style: {color: 'black'}},
    { name: 'reported', width:100, style: {color: 'black'}},
    { name: 'type', width:90, style: {color: 'black'}},
    { name: 'cat', width:90, style: {color: 'black'}},
    { name: 'sen', width:90, style: {color: 'black'}},
    { name: 'sec', width:90, style: {color: 'black'}},
    { name: 'deadline', width:90, style: {color: 'black'}}
]
