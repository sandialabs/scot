...
var FacetFilter = (function (_super) {
    ...
    FacetFilter.prototype.renderShowMore = function () {
        ...
        return (React.createElement(core_1.FastClick, {handler: function () { return _this.toggleViewMoreOption(option); }, key: "showMore"}, React.createElement("div", {"data-qa": "show-more", className: this.bemBlocks.container("view-more-action")}, this.translate(option.label))));
    };
