...
let SelectedContainer = React.createClass( {
    render: function() {
        let datarows = [];
        datarows.push( <SelectedHeader key={this.props.id} id={this.props.id} type={this.props.type} togglePreventClick={this.props.togglePreventClick} toggleEventDisplay={this.props.viewEvent} taskid={this.props.taskid} alertPreSelectedId={this.props.alertPreSelectedId} handleFilter={this.props.handleFilter} errorToggle={this.props.errorToggle} history={this.props.history} form={this.props.form}/> );
        let width = '100%';
