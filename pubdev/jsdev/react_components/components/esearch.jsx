        ...
        return (
            <div className='esearch'>
                <div style={{display:'flex'}}>
                    <input id='main-search' className='esearch-query' style={{marginTop:'3px',padding:'10px 10px', float:'right',position:'relative'}} placeholder="&#xF002; Search" charSet="utf-8" onKeyPress={this.handleEnterKey} onChange={this.onChange}/>
