                        ...
                        if (ifr.contentDocument != null) {
                            ...
                            ifrContents.find('.entity').each(function (index, entity) {
                                if ($(entity).find('.extras')[0] == null) {
                                    ...
                                    let currentEntityValue = $('<span />', { html: $(entity).attr('data-entity-value') }).html();
                                    if (currentEntityValue != undefined && entityResult != undefined) {
                                        ...
                                        if (entityMatched != undefined) {
                                            ...
                                            let entityCount = abbreviateNumber(parseInt(entityMatched.count), 0);
                                            ...
                                            if (entitydata != undefined) {
                                                if (entitydata.geoip != undefined) {
                                                    if (entitydata.geoip.data.isocode != undefined) {
                                                        ...
                                                        let flag = $('<img title="' + country_code.toLowerCase() + '">').attr('src', '/images/flags/' + country_code.toLowerCase() + '.png');
                                            ...
                                            if (entityEntryCount != undefined) {
                                                if (entityEntryCount != 0) {
                                                    let entityEntry = entityMatched.entries[0].body_plain.replace('"', '&quot');
