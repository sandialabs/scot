        ...
        if (type != 'alertgroup') {
            ...
            return (
                <div className="entry-header">
                    ...
                    <Button eventKey="2" bsStyle='success' onClick={this.props.fileUploadToggle} bsSize='xsmall'><i className="fa fa-upload" aria-hidden="true"></i> Upload File</Button>
                    ...
                    {showPromote ? <Button bsStyle='warning' eventKey="8" bsSize='xsmall'><img src='/images/megaphone.png'/> <Promote type={type} id={id} updated={this.props.updated} /></Button> : null}
                    ...
                    <Button bsStyle='info' eventKey="10" onClick={this.manualUpdate} bsSize='xsmall' style={{float:'right'}}><i className='fa fa-refresh' aria-hidden='true'></i></Button>
                </div>
            )
        } else {
            if (this.props.aIndex != undefined) {
                return (
                    <div className="entry-header second-menu">
                        ...
                        <Button eventKey="13" bsStyle='success' onClick={this.props.uploadFile} bsSize='xsmall'><i className="fa fa-upload" aria-hidden="true"></i> Upload File</Button>
