...
var SelectedContainer = React.createClass({
    ...
    render: function() {
        ...
        for (i=0; i < this.props.ids.length; i++) { 
            datarows.push(<SelectedHeader windowHeight={this.props.height} key={this.props.ids[i]} id={this.props.ids[i]} type={this.props.type} toggleEventDisplay={this.props.viewEvent}/>); 
        }
        return (
