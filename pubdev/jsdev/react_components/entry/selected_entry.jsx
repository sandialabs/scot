    ...
    render: function() { 
        ...
        return (
            <div key={id} className={divClass} style={{height:this.props.windowHeight}}> 
                ...
                {this.state.flairToolbar ? <Flair flairToolbarToggle={this.flairToolbarToggle} entityid={this.state.entityid} entityvalue={this.state.entityvalue} type={this.props.type} id={this.props.id}/>: null}
