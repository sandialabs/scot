    ...
    render: function() {
        ...
        return (
            <div>
                ...
                {this.state.flairToolbar ? <Flair key={this.state.entityid} flairToolbarToggle={this.flairToolbarToggle} entityid={this.state.entityid} entityvalue={this.state.entityvalue} type={this.props.type} id={this.props.id}/> : null}
