...
my $cmd = "sudo docker run --rm  --link scot_mongodb_1:mongo --network scot_scot-docker-net -v $downdir/opt/scotbackup/mongo/scot-prod:/backup mongo bash -c 'mongorestore  -d $dbname /backup --host 172.18.0.4:27017' ";
