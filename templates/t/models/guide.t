...
my $guide  = $mongo->collection("Guide");
ok (defined $guide, "Collection object is defined");

my $guide1    = $guide->create(
    subject     => "Guide 1",
    owner       => "tbruner",
...
ok (defined $guide1, "guide 1 created");
is ($guide1->id, 1, "ID is correct");
is ($guide1->subject, "Guide 1", "subject is correct");
