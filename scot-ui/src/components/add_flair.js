                            ...
                            if (entityMatched != undefined) {
                              ...
                              if (entitydata != undefined) {
                                if (entitydata.geoip != undefined) {
                                  if (
                                    entitydata.geoip.data.isocode != undefined
                                  ) {
                                    let country_code;
                                    if (
