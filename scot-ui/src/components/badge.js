...
export default class Badge extends React.Component {
    ...
    toggleBadgeEntry = () => {
        if (this.state.badgeEntry == false) {
            this.setState({ badgeEntry: true });
        } else if (this.state.BadgeEntry == true) {
            this.setState({ badgeEntry: false });
        }
    }
    ...
    render() {
        ...
        return (
            <th>
                ...
                <td>
                    {rows}
                    {this.state.badgeEntry ? <NewBadge data={data} type={type} id={id} badgeType={this.props.badgeType} toggleBadgeEntry={this.toggleBadgeEntry} updated={this.props.updated} errorToggle={this.props.errorToggle} /> : null}
                    {this.props.badgeType === 'tag' ?
                        ...
                        this.props.badgeType === 'source' ?
                            this.state.sourceEntry ? <span className='add-source-button'><Button bsSize={'xsmall'} bsStyle={'danger'} onClick={this.toggleBadgeEntry}><span className='glyphicon glyphicon-minus' aria-hidden='true'></span></Button></span> : <span className='remove-source-button'><Button bsSize={'xsmall'} bsStyle={'success'} onClick={this.toggleBadgeEntry}><span className='glyphicon glyphicon-plus' aria-hidden='true'></span></Button></span> : null}
                </td>
            </th>
        );
    }
